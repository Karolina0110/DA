...
namespace exp_model1_ppc_model_namespace {
...
class exp_model1_ppc_model final : public model_base_crtp<exp_model1_ppc_model> {
 ...
 public:
  ~exp_model1_ppc_model() { }
  
  inline std::string model_name() const final { return "exp_model1_ppc_model"; }
  ...
  exp_model1_ppc_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "exp_model1_ppc_model_namespace::exp_model1_ppc_model";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "exp_model1_ppc_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "exp_model1_ppc_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
    ...
    try {
      ...
      alpha = stan::math::normal_rng(0.17, 0.02, base_rng__);
      double beta = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 3;
      beta = stan::math::normal_rng(0.36, 0.02, base_rng__);
  ...
  inline void get_param_names(std::vector<std::string>& names__) const {
    ...
    names__ = std::vector<std::string>{"price", "alpha", "beta", "sigma",
      "lambda"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    ...
    return std::string("[{\"name\":\"price\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"alpha\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"beta\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"lambda\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
...
using stan_model = exp_model1_ppc_model_namespace::exp_model1_ppc_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return exp_model1_ppc_model_namespace::profiles__;
}
